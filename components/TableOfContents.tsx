...
const TableOfContents: React.FC<TableOfContentsProps> = ({ editorRef, content, t }) => {
  ...
  return (
    <div className="hidden lg:block w-64 flex-shrink-0 bg-white/95 dark:bg-gray-950/95 backdrop-blur-md border-r border-white/20 dark:border-white/5 overflow-y-auto p-6 custom-scrollbar select-none">
